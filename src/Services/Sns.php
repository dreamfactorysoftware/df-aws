...
class Sns extends BaseRestService
{
    ...
    protected function handleResource(array $resources )
    {
        ...
        if ( ( ( SnsSubscription::RESOURCE_NAME == $this->relatedResource ) && ( SnsTopic::RESOURCE_NAME == $this->resource ) ) ||
             ( ( SnsEndpoint::RESOURCE_NAME == $this->relatedResource ) && ( SnsApplication::RESOURCE_NAME == $this->resource ) )
        )
        {
    ...
    public function publish( $request, $resource_type = null, $resource_id = null )
    {
        ...
        switch ( $resource_type )
        {
            ...
            default:
                ...
                $_endpoint = ArrayUtils::get( $_data, 'Endpoint', ArrayUtils::get( $_data, 'EndpointArn', ArrayUtils::get( $_data, 'TargetArn' ) ) );
                if ( !empty( $_topic ) )
                {
